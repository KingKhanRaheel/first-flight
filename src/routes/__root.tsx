...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "After12 AI — Your Career, College & Scholarship Roadmap" },
      {
        name: "description",
        content:
          "AI-powered guidance for Class 11–12 students in India. Discover careers, shortlist colleges, and find scholarships you actually qualify for.",
      },
    ],
    links: [
